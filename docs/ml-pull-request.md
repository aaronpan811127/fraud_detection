...
Opening a pull request will trigger a[workflow](../.github/workflows/fraud_detection-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/staging/fraud_detection/fraud_detection-model)
* [Prod model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/prod/fraud_detection/fraud_detection-model)
. 

...
git add README.md docs .gitignore fraud_detection/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[fraud_detection/databricks.yml](../fraud_detection/databricks.yml) file.
...
Follow the instructions in [fraud_detection/resources/README.md](../fraud_detection/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../fraud_detection/resources/README.md)  to propose, test, and deploy
